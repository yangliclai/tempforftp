...
/*vot*/	s += '<th><a href="###" onclick="refreshcalendar(yy, mm-1)" title="Prev Month">&laquo;</a></th>';
/*vot*/	s += '<th colspan="5" style="text-align: center"><a href="###" onclick="showdiv(\'year\');_cancelBubble(event)" title="Select Year" id="year"></a>&nbsp; - &nbsp;<a id="month" title="Select Month" href="###" onclick="showdiv(\'month\');_cancelBubble(event)"></a></th>';
/*vot*/	s += '<th><a href="###" onclick="refreshcalendar(yy, mm+1)" title="Next Month">&raquo;</A></th>';
	s += '</tr>';
