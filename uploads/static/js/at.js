...
/*vot*/		return 'Please enter the user name:<br /><input type="text" id="atkeyword" style="width:240px" value="" class="px" onkeydown="atEnter(event, \'atListSet\')" onkeyup="atFilter(this.value, \'at_list\',\'atListSet\',event, true);" /><div class="p_pop" id="at_list" style="width:250px;"><ul><li>@user, you can remind him to view the post</li></ul></div>';
	} else {
		if($('atkeyword').value) {
...
/*vot*/	$('at_menu').innerHTML = '<img src="' + IMGDIR + '/loading.gif" class="vm"> Loading ...';
}
...
/*vot*/			$(id).innerHTML = '<ul>' + newlist + '<li class="xg1">@user, you can remind him to view the post</li></ul>';
		} else {
