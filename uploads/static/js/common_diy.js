...
(function(){
	...
	Drag.prototype = {
		...
		toggleContent : function (e) {
			...
			if(display != '') {
/*vot*/				e.aim.src=STATICURL+'image/common/fl_collapsed_no.gif';
			} else {
/*vot*/				e.aim.src=STATICURL+'image/common/fl_collapsed_yes.gif';
			}
		},
		checkEdit : function (ele) {
			...
			if (!$(id+'_edit')) {
				...
				dom.id = id+'_edit';
/*vot*/				dom.innerHTML = '<span id="'+id+'_edit_menu">Edit</span>';
				ele.appendChild(dom);
...
/*vot*/				alert('Select an image to upload');
				return false;
			}
		...
		cancel : function () {
			var flag = false;
			if (this.isChange) {
/*vot*/				flag = confirm(this.cancelConfirm ? this.cancelConfirm : 'All the changes will be lost if you exit. Are you sure you want to exit now?');
			}
