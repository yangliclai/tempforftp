		...
		if (el != null) {
			...
			x.get('home.php?mod=spacecp&ac=index&op=getblock&blockname='+blockname+'&inajax=1',function(s) {
				if (s) {
					...
					el.id = blockname;
/*vot*/					s = s.replace(/\<script.*\<\/script\>/ig,'<font color="red"> [javascript saved] </font>');
					el.innerHTML = s;
...
/*vot*/			dom.innerHTML = '<span id="editnvinfo" class="edit" style="background-color:#336699;" onclick="spaceDiy.opNvEditInfo();">Settings</span>';
