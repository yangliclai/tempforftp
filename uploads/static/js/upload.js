...
function fileQueued(file) {
	try {
		...
		if(createQueue) {
/*vot*/			progress.setStatus('Wait for upload...');
		} else {
...
/*vot*/			showDialog('You have selected too many files.\n'+(message === 0 ? 'You can not add any more files.' : 'You yet can choose ' + message + ' files'), 'notice', null, null, 0, null, null, null, null, sdCloseTime);
			return;
		}
