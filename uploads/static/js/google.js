...
/*vot*/ document.writeln('<option value="0"' + google_default_0 + '>Search in the Net</option>');
/*vot*/ document.writeln('<option value="1"' + google_default_1 + '>Search in the site</option>');
document.writeln('</select>');
/*vot*/ document.writeln('&nbsp;<button type="submit" name="sa" value="true">Search</button>');
