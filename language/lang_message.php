...
$lang = array (
	...
	'login_succeed'			=> 'Welcome {usergroup} {username}!<br />Now redirecting to the previous page.',//'欢迎您回来，{usergroup} {username}，现在将转入登录前页面',
...
/*3.2*/	'mobile_template_no_found'	=> 'You have visited the page without a mobile phone. Would you like to further access to the PC version?<br /><br /><a href="{url}">Continue access</a><br /><br />',//'您访问的页面无手机页面，是否进一步访问电脑版？<br /><br /><a href="{url}">继续访问</a><br /><br />',
	...
	'favorite_do_success'		=> 'Added to Favorites successfully.',//'收藏信息成功。',
	...
	'login_succeed_inactive_member'	=> 'Welcome back {username}!<br/>You account needs to be activated, now redirect you to control panel.',//'欢迎您回来，{usergroup} {username}。您的帐号处于非激活状态，现在将转入控制面板',
